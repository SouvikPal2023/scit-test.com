                                    ...
                                    $logicBlock .='<div class="form-group extra  d-flex justify-content-between ">
                                        ...
                                        $logicBlock .='<span class="msgbox" style="display:none;">
                                            <div class="form-group">
                                                ...
                                                <input  class="form-control addtext addtext1" placeholder="True Text" type="text" name="textmsg2['.$group_id.']['.$logic['factor_id'].']['.$Examkey.']" value="'.$logic['textmsg1'].'" >
                                                <textarea class="form-control addtext addtext1" placeholder="True Text" name="textmsg2['.$group_id.']['.$logic['factor_id'].']['.$Examkey.']" value="'.$logic['textmsg1'].'"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label class="font-weight-bold">False Text<span class="text-danger">*</span></label>
                                                <input  class="form-control addtext addtext2" placeholder="False Text" type="text" name="textmsg3['.$group_id.']['.$logic['factor_id'].']['.$Examkey.']" value="'.$logic['textmsg2'].'" >
                                                <textarea class="form-control addtext addtext2" placeholder="False Text" name="textmsg3['.$group_id.']['.$logic['factor_id'].']['.$Examkey.']" value="'.$logic['textmsg2'].'" ></textarea>
                                            </div>
                                        </span>';
                                        $logicBlock .='<div class="form-group addtextblock">
                                           <label class="font-weight-bold">Add Text<span class="text-danger">*</span></label>
                                           <input  class="form-control addtext addtext3" placeholder="Add Text" type="text" name="textmsg1['.$group_id.']['.$logic['factor_id'].']['.$Examkey.']" value="'.$logic['textmsg1'].'" >
                                           <textarea class="form-control addtext addtext3" placeholder="Add Text" name="textmsg1['.$group_id.']['.$logic['factor_id'].']['.$Examkey.']" value="'.$logic['textmsg1'].'"></textarea>
                                        </div>';
    ...
    public function examViewReports($examid)
    {
        ...
        if (!empty($categories_list)) {
            ...
            if ($examid) {
                ...
                $results = fractal(Result::with('exam','user')->where('exam_id',$examid)->get() , new ResultTransformer($categories_list,$examid))->toArray();
               ...
               return view('admin.exam.report',compact('results','categories_list','page_title','consistencytotal'));
            }
        ...
        if($exam->question_type == 1){
           ...
           //dd($result[0]);
            if($result[0]){
                ...
                return view('admin.exam.viewreport',compact('page_title','exam','result','result_group','new_examLogic','scoreTrue','new_questionAns','new_filter_question','new_question'));
            }
        }
