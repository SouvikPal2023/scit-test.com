                        ...
                        <table class="table table--light style--two custom-data-table">
                            ...
                            @forelse($pdata as $k => $data)
                                <tr>
                                    ...
                                    <td data-label="@lang('status')"><span class="text--small badge font-weight-normal  @php echo ($data->status == 1)?'badge--success':'badge--danger'; @endphp  p-1">@php echo ($data->status == 1)?'Active':'Inactive'; @endphp</span></td>
