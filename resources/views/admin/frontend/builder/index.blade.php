            ...
            <div class="card-body">
                <form action="{{ route('admin.frontend.manage.pages.update')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group"> @php $status = $pdata->status @endphp
                                    <label class="form-control-label font-weight-bold">@lang('Display OR Not') </label>
                                    <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Active')"  data-off="@lang('Inactive')" name="status"  @if($status == 1) checked @endif >
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
...
@push('script-lib')
<script src="{{asset('public/assets/admin/js/jquery-sortable.js')}}"></script>
@endpush
