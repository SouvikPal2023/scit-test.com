                                                        ...
                                                        <div class="thumb">
                                                            <div class="avatar-preview">
                                                                <div class="profilePicPreview"
                                                                     ...
                                                                     style="background-image: url({{getImage('public/assets/images/frontend/' . $key .'/'. @$content->data_values->$imgKey,@$section->content->images->$imgKey->size) }})">
                                        ...
                                        <td data-label="@lang('Image')">
                                            <div class="customer-details d-block">
                                                <a href="javascript:void(0)" class="thumb">
                                                    <img src="{{ getImage('public/assets/images/frontend/' . $key .'/'. @$data->data_values->$firstKey,@$section->element->images->$firstKey->size) }}" alt="@lang('image')">
                                                </a>
                                            </div>
                                        </td>
                                    @endif
                                        ...
                                        @php
                                            ...
                                            if(@$section->element->images){
                                                foreach($section->element->images as $imgKey => $imgs){
                                                    $images[] = getImage('public/assets/images/frontend/' . $key .'/'. @$data->data_values->$imgKey,@$section->element->images->$imgKey->size);
                                                }
                                            }
                                        @endphp
...
@push('style-lib')
    <link rel="stylesheet" href="{{ asset('public/assets/admin/css/bootstrap-iconpicker.min.css') }}">
@endpush
@push('script-lib')
    <script src="{{ asset('public/assets/admin/js/bootstrap-iconpicker.bundle.min.js') }}"></script>
@endpush
