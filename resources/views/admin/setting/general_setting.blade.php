                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group ">
                                    ...
                                    <label class="form-control-label font-weight-bold">@lang('Registration Bonus Amount') </label>

                                    <input class="form-control form-control-lg" type="text" name="registration_bonus" value="{{$general->registration_bonus}}">
...
@push('script-lib')
    ...
    <script src="{{ asset('public/assets/admin/js/spectrum.js') }}"></script>
...
@push('style-lib')
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/admin/css/spectrum.css') }}">
