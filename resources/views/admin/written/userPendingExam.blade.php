                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                <td data-label="@lang('Exam Title')">
                                    <div class="user">
                                        <div class="thumb"><img src="{{getImage('public/assets/images/exam/'.$pending->exam->image)}}" alt="image"></div>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{route('admin.written.details.user',[$pending->user_id,$pending->exam_id])}}" class="icon-btn" data-toggle="tooltip" data-original-title="@lang('Details')">
