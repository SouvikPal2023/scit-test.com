                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                <td data-label="@lang('Exam Title')">
                                    <div class="user">
                                        <div class="thumb"><img src="{{getImage('public/assets/images/exam/'.$rev->exam->image)}}" alt="image"></div>
                                        <span class="name">{{$rev->exam->title}}</span>
                                    </div>
                                </td>
                                <td data-label="@lang('Category')">{{$rev->exam->subject->category->name}}</td>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{route('admin.written.reviewed.exam.details',$rev->exam_id)}}" class="icon-btn" data-toggle="tooltip" data-original-title="@lang('Details')">
