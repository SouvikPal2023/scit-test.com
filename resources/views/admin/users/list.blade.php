                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="javascript:void(0)" data-category="{{$user}}" data-route="{{ route('admin.users.delete', $user->id) }}"  class="icon-btn delete" data-toggle="tooltip" title="" data-original-title="@lang('Delete')">
