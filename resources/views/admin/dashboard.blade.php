            ...
            <div class="dashboard-w1 bg--4 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        ...
                        <span class="text--small">@lang('Total Test')</span>
            ...
            <div class="dashboard-w1 bg--gradi-7 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        ...
                        <span class="text--small">@lang('Total Mcq Test')</span>
            ...
            <div class="dashboard-w1 bg--gradi-35 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        ...
                        <span class="text--small">@lang('Total Written Test')</span>
...
@push('script')
    ...
    <script src="{{asset('public/assets/admin/js/vendor/apexcharts.min.js')}}"></script>

    <script src="{{asset('public/assets/admin/js/vendor/chart.js.2.8.0.js')}}"></script>
