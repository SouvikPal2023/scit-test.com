               ...
               <div class="row ">
                    ...
                    <div class="col-md-8">
                        <div class="card shadow mb-4 template_default">
                            ...
                            <a href="#collapsePage" class="d-block card-header py-3" data-toggle="collapse"
                                role="button" aria-expanded="true" aria-controls="collapsePage">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="name"
                                                ...
                                                value="{{ old('name') }}" required="" placeholder="Page Title" />
                       ...
                       @include('admin.page.pages.faq') 
                        ...
                        {{-- Start privacy Template --}}

                      @include('admin.page.pages.privacy')

                        {{-- End privacy Template --}}
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card shadow mb-4">
                            <!-- Card Header - Accordion -->
                            <a href="#collapsePageDetails" class="d-block card-header py-3" data-toggle="collapse"
                                role="button" aria-expanded="true" aria-controls="collapsePageDetails">
                                    ...
                                    <div class="form-group form-float">
                                        <select class="form-control show-tick" name="template" id="page-template">
                                            <option value="template_default"
                                                {{ old('template') == "template_default" ? "selected" : "" }}>
                                                Template Default
                                            </option>
                                            <option value="template_home"
                                                {{ old('template') == "template_home" ? "selected" : "" }}>
                                                Template Home
                                            </option>
                                            <option value="template_about"
                                                {{ old('template') == "template_about" ? "selected" : "" }}>
                                                Template How-it-works
                                            </option>

                                            <option value="template_contact"
                                                {{ old('template') == "template_contact" ? "selected" : "" }}>
                                                Template Contact
                                            </option>
                                            <option value="template_privacy"
                                                {{ old('template') == "template_privacy" ? "selected" : "" }}>
                                                Template Privacy Policy
                                            </option>
                                            <!-- <option value="template_additionals"
                                                {{ old('template') == "template_additional" ? "selected" : "" }}>
                                                Template Terms & Condition
                                            </option> -->
                                            <option value="template_faq"
                                                {{ old('template') == "template_faq" ? "selected" : "" }}>
                                                FAQ
                                            </option>
                                        </select>
                                    </div>
                        ...
                        <div class="card shadow mb-4">
                            <!-- Card Header - Accordion -->
                            <a href="#collapseSeoContent" class="d-block card-header py-3" data-toggle="collapse"
                                role="button" aria-expanded="true" aria-controls="collapseSeoContent">
                            ...
                            <div class="collapse show" id="collapseSeoContent" style="">
                                <div class="card-body">
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            <input type="text" name="seo_title" cols="30" rows="6"
                                                class="form-control tinymce" value="{{ old('seo_title') }}">
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            <textarea name="meta_content" cols="30" rows="6" name="meta_content"
                                                class="form-control tinymce">{{ old('meta_content') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
