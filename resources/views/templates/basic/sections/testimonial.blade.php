...
<section class="client-section ptb-80 section--bg bg-overlay-white bg_img" data-background="{{getImage('public/assets/images/frontend/testimonial/'.@$content->background_image,'1920x1080')}}">
    <div class="container">
                            ...
                            <div class="client-item">
                                ...
                                <div class="client-thumb-area">
                                    <div class="client-thumb">
                                        <img src="{{getImage('public/assets/images/frontend/testimonial/'.$el->data_values->author_image,'70x70')}}" alt="client">
                                    </div>
                                    <div class="client-thumb-content">
                                        <h3 class="title">{{$el->data_values->author_name}}</h3>
                                        <span class="sub-title">{{__($el->data_values->author_designation)}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
