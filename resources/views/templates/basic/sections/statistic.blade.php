...
@endphp
<section class="statistics-section ptb-80 bg-overlay-white bg_img" data-background="{{getImage('public/assets/images/frontend/statistic/'. @$content->background_image,'1920x450')}}">
    <div class="container">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-30">
                        <div class="statistics-item text-center">
                            ...
                            <div class="statistics-content">
                                <div class="odo-area">
                                    <h3 class="odo-title odometer" data-odometer-final="{{$el->data_values->count}}">0</h3>
                                    <h3 class="title">+</h3>
                                </div>
                            </div>
