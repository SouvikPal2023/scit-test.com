@php
    $categories = \App\Category::where('status',1)->where('hide',1)->get();
@endphp
            ...
            <div class="container">
                ...
                <div class="header-menu-content">
                    ...
                    <nav class="navbar navbar-expand-lg p-0">
                        ...
                        <a class="site-logo site-title" href="{{url('/')}}"><img src="{{asset('assets/images/logoIcon/logo.png')}}" width="120" alt="logo"></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav main-menu ml-auto mr-auto">
                               ...
                               {{-- <li class="menu_has_children"><a href="javascript:void(0)">@lang('Categories')</a>
                                ...
                                <li><a href="{{route("exams")}}">@lang('Tests')</a></li> --}}
