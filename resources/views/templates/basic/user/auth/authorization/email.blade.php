            ...
            <div class="col-lg-5">
                ...
                <div class="account-form-area">
                    ...
                    <div class="account-header text-center">
                        ...
                        <h2 class="title">@lang('Email Verification')</h2>

                    </div>

                    <form class="account-form" action="{{route('user.verify_email')}}" method="POST">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <div class="checkbox-wrapper d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="checkbox-item">
                                        ...
                                        <label>@lang('Please check including your Junk/Spam Folder. if not found, you can') <a href="{{route('user.send_verify_code')}}?type=email" class="forget-pass"> @lang('Resend code')</a></label>
