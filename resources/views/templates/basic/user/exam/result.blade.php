...
<style type="text/css">
    ...
    @media print {
        ...
        body .sidebar-menu, .copyright-wrapper, .footer-botton{
    ...
    <div class="row justify-content-center mb-30-none">
        <div class="col-xl-10 col-md-8 col-sm-10 mb-30" id="printarea">
            <div class="panel-table-area">
                <div class="panel-table border--base">
                    <div class="panel-card-body">
                        ...
                        <p class="text-center">Date of Report: {{date('F d, Y',strtotime($result->created_at))}}<span class="datetoday1"></span></p>
                                        ...
                                        @php if ($i == $countFactor): @endphp
                                                ...
                                                <ul class="">
                                                    @foreach($examlogicsresult as $msg)
                                                        @php echo (!empty($msg))? '<li class="carrige_return_25"><span style="font-size: x-large;">&#x2022; </span> '. $msg .'</li>':''; @endphp
                                                    @endforeach
                                                </ul>                                      
                                        @php endif  @endphp
                                        <?php  } //factor check
            ...
            <div class="text-center mt-3 footer-botton">
                <a href="javascript:void(0)" onclick="print_block()" class="btn--primary border--rounded p-1 pl-4 pr-4 text-white">Print </a>
