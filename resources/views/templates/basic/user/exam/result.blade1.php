...
@php $result_data = json_decode($result->result,true);
    // Get consistency
    $consistency = array();
...
<div class="transaction-area mt-30">
    <div class="row justify-content-center mb-30-none">
        <div class="col-xl-8 col-md-8 col-sm-8 mb-30">
            <div class="panel-table-area">
                <div class="panel-table border--base">
                    <div class="panel-card-body">
                        ...
                        <p class="text-center">Date of Report: {{date('d-m-Y',strtotime($result->created_at))}}<span class="datetoday1"></span></p>
                        <p class="mx-4">The SCIT scores are based upon the responses you provided.  Each variable is compared with the scores obtained from other people of your sex who have also completed the SCIT.  Given that more people will complete the test in the future, you can update your statistics if you check your report as many times as you like within one year of your SCIT completion date.  Note that the total sample may not be completely representative of the general population and there will likely be some variance between our sample and the general population.
                        </p>
                        <p class="mx-4">Each variable is represented by a percentile score.  A percentile score is a statistical calculation that for our purposes ranges from 1 to 99.  A percentile score shows how your score compared to those from our sample.   A score of 75 for example, means that approximately 74 percent of the sample scored lower than you did.   Conversely, it also means that approximately 25 percent of the sample scored higher than you did.</p>
