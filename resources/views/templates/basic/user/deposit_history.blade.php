                                    ...
                                    @foreach($logs as $k=>$data)
                                        <tr>
                                            ...
                                            <td data-label="@lang('Details')">
                                                <a href="javascript:void(0)" class="btn--primary border--rounded text-white px-2 py-1 approveBtn"
                                                   data-info="{{$details}}"
                                                   data-id="{{ $data->id }}"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="border--rounded btn--dark text-white p-2" data-dismiss="modal">@lang('Close')</button>
                    </div>
                </div>
            </div>
        </div>
